...
namespace irondust
{
    namespace gl
    {
        ...
        GLSLShader::GLSLShader(const ShaderType type, const std::string& filename, bool isCode, bool cleanUpOnFree)
            : type(type)
            , cleanUpOnFree(cleanUpOnFree)
        {
