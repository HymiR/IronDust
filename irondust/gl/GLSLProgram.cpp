...
namespace irondust
{
    namespace gl
    {
        ...
        std::string GLSLProgram::getInfoLog(GLuint programId)
        {
            ...
            assert(log);
            glGetProgramInfoLog(programId, infolen, nullptr, log);
            std::string slog(log);
            delete[] log;
        ...
        void GLSLProgram::unbind() const { glUseProgram(0); }


        GLSLProgram* GLSLProgram::create(
        ...
        GLSLProgram* GLSLProgram::createFromSource(
        ...
        GLSLAttrib GLSLProgram::operator[](const std::string& arg)
        {
            ...
            if(id < 0) {
                ...
                switch(err) {
                case 0:
                    LOG_WARN << arg << ": no error but id " << id << std::endl;
                    break;
